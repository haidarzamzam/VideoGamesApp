...
data class VideoGamesListResponse(
    ...
    data class Filters(
        ...
        data class Year(
            ...
            @SerializedName("years") val years: List<YearX>
        ) {
            data class YearX(
                @SerializedName("count") val count: Int,
                @SerializedName("nofollow") val nofollow: Boolean,
    ...
    data class Result(
        ...
        @SerializedName("platforms") val platforms: List<PlatformX>,
        ...
        data class ShortScreenshot(
            @SerializedName("id") val id: Int, @SerializedName("image") val image: String
        )

        data class Store(
            @SerializedName("id") val id: Int, @SerializedName("store") val store: StoreX
        ) {
            data class StoreX(
